...
boden::widget::view_ref_t view_controller_t::get_view() 
{
    if(_view == nullptr) 
    {
        load_view();
...
void view_controller_t::set_parent(boden::widget::view_controller_ref_t ctrl)
{
    _parent = ctrl;
}

void view_controller_t::add_child_view_controller(boden::widget::view_controller_ref_t crtl)
{
