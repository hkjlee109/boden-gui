...
layout_constraint_t::layout_constraint_t(boden::widget::view_ref_t first_item,
...
boden::widget::view_ref_t layout_constraint_t::get_first_item() const 
{
    return _first_item.lock();
}

boden::widget::view_ref_t layout_constraint_t::get_second_item() const 
{
    return _second_item.lock();
}

boden::widget::layout::layout_attribute_t layout_constraint_t::get_first_attribute() const 
{
    return _first_attr;
}

boden::widget::layout::layout_attribute_t layout_constraint_t::get_second_attribute() const 
{
    return _second_attr;
}

boden::widget::layout::layout_relation_t layout_constraint_t::get_relation() const 
{
    return _relation;
}

boden::widget::view_ref_t layout_constraint_t::find_common_superview(boden::widget::view_ref_t v1, 
